(() => {
    ...
    (() => {
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".comments-slider")) new core(".comments-slider", {
            ...
            if (document.querySelector(".tariff-page-slider")) new core(".tariff-page-slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".connection-page-slider")) new core(".connection-page-slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
